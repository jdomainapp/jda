...
public abstract class DefaultController2<T, ID> implements BasicRestController<T, ID> {

	private static final Logger logger = LoggerFactory.getLogger(DefaultController2.class);
