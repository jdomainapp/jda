...
public class BrowseFirstToLast extends DODMEnhancedTester {  
  ...
  public void doTest() throws Exception { 
    ...
    // loop from min to max to get next
    Oid oid = minId;
    Object o;
    ...
    do {
      oid = me.getIdFirstAfter(c, oid);
      if (oid != null) {
        System.out.printf("Next id: %s%n", oid);
        o = me.retrieveObject(c, oid);
        System.out.printf("--> object: %s%n", o);
      }
    } while (oid != null);
