        ...
        return (<>
          {
            ...
            <EnrolmentListItemView key={item.id} current={item}
...
<td style={this.verticalAlignCell} onClick={this.changeCurrent}>{this.renderObject(this.props.current.student)}</td>
<td style={this.verticalAlignCell} onClick={this.changeCurrent}>{this.renderObject(this.props.current.courseModule)}</td>
