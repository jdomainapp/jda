...
public class Generator extends Machine {
    ...
    public Generator(@AttrRef(value = "id") Integer id, @AttrRef(value = "operator") Operator operator) throws ConstraintViolationException {
        super(id, operator);
    }

    @DOpt(type = DOpt.Type.ObjectFormConstructor, requires = "", effects = "")
    @DOpt(type = DOpt.Type.RequiredConstructor)
    public Generator(@AttrRef(value = "operator") Operator operator) throws ConstraintViolationException {
        super(operator);
    }
}
