package org.jda.example.courseman.modulesref.student.model;

import java.util.ArrayList;
import java.util.Collection;

import org.jda.example.courseman.modulesref.coursemodule.model.CourseModule;
import org.jda.example.courseman.modulesref.enrolment.model.Enrolment;
import org.jda.example.courseman.modulesref.sclass.model.SClass;
import org.jda.example.courseman.modulesref.sclassregist.model.SClassRegistration;
...
public class Student{
  ...
  @DAssoc(ascName = "M1-m-assoc-M2", role = "r1", ascType = AssocType.Many2Many, endType = AssocEndType.Many, associate = @Associate(type = SClass.class, cardMin = 0, cardMax = DCSLConstants.CARD_MORE), normAttrib = "classRegists")
  ...
  private org.jda.example.courseman.modulesref.enrolmentmgmt.model.EnrolmentMgmt enrolmentMgmt2;
