...
public class Student {
    ...
    public Student(@AttrRef(value = "id") Integer id, @AttrRef(value = "name") String name, @AttrRef(value = "address") Address address) throws ConstraintViolationException {
        this.id = genId(id);
        this.name = name;
        this.address = address;
    ...
    public Student(@AttrRef(value = "name") String name, @AttrRef(value = "address") Address address) throws ConstraintViolationException {
        this.id = genId(null);
        this.name = name;
        this.address = address;
        this.enrolments = new ArrayList<>();
    ...
    public Student(@AttrRef(value = "name") String name) throws ConstraintViolationException {
        this.id = genId(null);
        this.name = name;
        this.address = null;
        this.enrolments = new ArrayList<>();
