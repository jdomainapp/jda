...
const getStudentClass = (student_class_id) =>
    client.get(END_POINT + "/" + student_class_id);
const deleteStudentClass = (student_class_id) =>
    client.delete(END_POINT + "/" + student_class_id);
const addStudentClass = (data) => client.post(END_POINT, data);
const updateStudentClass = (student_class_id, data) =>
    client.patch(END_POINT + "/" + student_class_id, data);
