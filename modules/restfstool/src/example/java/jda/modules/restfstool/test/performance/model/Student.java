package jda.modules.restfstool.test.performance.model;
...
import jda.modules.restfstool.test.performance.model.utils.Deserializers;
...
public class Student implements Subscriber, Publisher {
    ...
    @DAssoc(ascName = "class-has-student", role = "student",
            ...
            associate = @Associate(type = StudClass.class, cardMin = 1, cardMax = 1))
    @JsonIgnoreProperties({"students"})
    @JsonDeserialize(using = Deserializers.StudClsDeserializer.class)
    private StudClass studentClass;
    ...
    public Student(@AttrRef("name") String name,
                   ...
                   @AttrRef("address") Address address,
                   @AttrRef("email") String email,
                   @AttrRef("studentClass") StudClass studentClass) {
    ...
    public Student(@AttrRef("id") String id,
                   ...
                   @AttrRef("email") String email, @AttrRef("studentClass") StudClass studentClass)
    ...
    public void setStudentClass(StudClass studentClass) {
...
//    }
    ...
    public StudClass getStudentClass() {
        return studentClass;
    }
