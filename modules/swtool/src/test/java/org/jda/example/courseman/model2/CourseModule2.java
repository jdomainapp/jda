...
public class CourseModule2 {
    ...
    @DAssoc(ascName = "mod-has-enrols", role = "module", ascType = AssocType.One2Many, endType = AssocEndType.One, associate = @Associate(type = Enrolment2.class, cardMin = 0, cardMax = DCSLConstants.CARD_MORE))
