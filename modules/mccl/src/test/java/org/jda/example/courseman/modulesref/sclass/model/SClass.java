package org.jda.example.courseman.modulesref.sclass.model;
...
public class SClass implements DomainIdable {
  ...
  @DAssoc(ascName = "M2-m-assoc-M1", role = "r2", ascType = AssocType.Many2Many, endType = AssocEndType.Many, associate = @Associate(type = Student.class, cardMin = 0, cardMax = DCSLConstants.CARD_MORE), normAttrib = "classRegists")
