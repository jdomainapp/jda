...
import org.jda.example.courseman.software.config.enrolmentmgmt.MergedSystemClass;
 ...
 * @version 
 */
public class MergedCourseManSoftware {
  
  public static void main(String[] args) {
    try {
      // create a default software needed to run the activity
      Software sw = SoftwareFactory.createSoftwareWithMemoryBasedConfig(MergedSystemClass.class);
