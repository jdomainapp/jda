...
@loop{importPaths}[[
import { @slot{{MODULE_NAME}}_INDEX_PATH, @slot{{MODULE_NAME}}_LIST_PATH, @slot{{MODULE_NAME}}_ADD_PATH, @slot{{MODULE_NAME}}_EDIT_PATH } from './path.js']]loop{importPaths}@
...
export const router = new VueRouter({
    routes: [
        ...
        { path: @slot{{MODULE_NAME}}_EDIT_PATH, name: @slot{{MODULE_NAME}}_EDIT_NAME, component: @slot{{MODULE_NAME}}_EDIT },
        ]]loop{routeDeclarations}@
    ]
})