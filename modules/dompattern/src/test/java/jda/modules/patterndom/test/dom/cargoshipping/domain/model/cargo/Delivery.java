...
public class Delivery implements ValueObject<Delivery> {
  ...
  static Delivery derivedFrom(RouteSpecification routeSpecification,
    ...
    final HandlingEvent lastEvent = handlingHistory
  ...
  private HandlingActivity calculateNextExpectedActivity(
        ...
        if (leg.unloadLocation().sameIdentityAs(lastEvent.location())) {
          if (it.hasNext()) {
            ...
            return new HandlingActivity(HandlingEvent.Type.LOAD,
                nextLeg.loadLocation(), nextLeg.voyage());
          } else {
    ...
    case RECEIVE:
      ...
      return new HandlingActivity(HandlingEvent.Type.LOAD,
          firstLeg.loadLocation(), firstLeg.voyage());
  ...
  private boolean calculateUnloadedAtDestination(
    ...
    return lastEvent != null
        ...
        && routeSpecification.destination()
            .sameIdentityAs(lastEvent.location());
  }
  ...
  public boolean sameValueAs(final Delivery other) {
    return other != null && new EqualsBuilder()
        ...
        .append(this.misdirected, other.misdirected).append(this.eta, other.eta)
  ...
  public int hashCode() {
    return new HashCodeBuilder().append(transportStatus)
        .append(lastKnownLocation).append(currentVoyage).append(misdirected)
        .append(eta).append(nextExpectedActivity)
