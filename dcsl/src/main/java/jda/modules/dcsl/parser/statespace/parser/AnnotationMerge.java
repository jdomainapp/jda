...
/**
 * @overview 
 *  A {@link VoidVisitor} that walks the AST of an annotation to merge its elements with another. 
 *  
 * @author dmle
 *
 * @version 5.4.1
 */
public class AnnotationMerge extends VoidVisitorAdapter<AnnotationExpr> {
  
  private String pkgName;
  private List<String> imports;
  
  private static Logger logger = LoggerFactory.getLogger(AnnotationMerge.class.getSimpleName());
  
  /**
   * @effects 
   *  initialise this with the arguments
   */
  public AnnotationMerge(String pkgName, List<String> imports) {
  ...
  public void visit(MemberValuePair pair, AnnotationExpr anoExpr) {
    ...
    */
    ...
    throw new NotImplementedException(AnnotationMerge.class+".visit()");
  }
