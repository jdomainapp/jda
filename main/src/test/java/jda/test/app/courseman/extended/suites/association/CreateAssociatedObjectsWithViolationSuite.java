...
import jda.test.app.courseman.extended.units.association.CreateAssociatedObjectsWithViolation;
...
@Suite.SuiteClasses({
  ...
  LoadObjects.class,
  Spacer.class,
  CreateAssociatedObjectsWithViolation.class,
        })
public class CreateAssociatedObjectsWithViolationSuite {
  // define a test suite
}
