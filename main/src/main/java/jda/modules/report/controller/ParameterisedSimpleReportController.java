 ...
 *  reports <b>All</b> input attributes of whom are considered as parameters.
 *  
 *  <p>This differs from {@link ParameterisedSearchReportController} in that <b>all</b> input attributes 
 *   (incl. those whose values are <tt>null</tt>) are considered.
 *  
 * @author dmle
 */
public class ParameterisedSimpleReportController<C> extends ParameterisedReportController<C> {
  
  public ParameterisedSimpleReportController(DODMBasic schema, ApplicationModule module,
  ...
  protected Class generateReportQuery(Query<ObjectExpression> q, Report report) {
     ...
     *    Every input attribute value is accounted for (including null)
     *    
...
//          continue; // skip this attribute if no input is specified
      ...
      */
      Object inputVal = reportDctl.getDataFieldValue(inputAttrib);
