...
import jda.test.app.courseman.extended.units.association.GetAssociationLinkCount;
...
@Suite.SuiteClasses({
  ...
  LoadObjects.class,
  Spacer.class,
  GetAssociationLinkCount.class,
        })
public class GetAssociationLinkCountSuite {
  // define a test suite
}
