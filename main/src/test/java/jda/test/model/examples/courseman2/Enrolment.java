...
public class Enrolment implements Comparable {
  ...
  @DAssoc(ascName = "module-has-enrolments", role = "enrolment", ascType = AssocType.One2Many, endType = AssocEndType.Many, associate = @Associate(type = CourseModule.class, cardMin = 1, cardMax = 1), dependsOn = true)
  ...
  // constructor method
  public Enrolment(Student s, CourseModule m) throws ConstraintViolationException {
