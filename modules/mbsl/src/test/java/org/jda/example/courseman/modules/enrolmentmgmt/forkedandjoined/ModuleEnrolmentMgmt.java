package org.jda.example.courseman.modules.enrolmentmgmt.forkedandjoined;
...
import org.jda.example.courseman.modules.enrolmentmgmt.forked.ModuleFEnrolmentProcessing;
import org.jda.example.courseman.modules.enrolmentmgmt.forked.model.control.FEnrolmentProcessing;
import org.jda.example.courseman.modules.enrolmentmgmt.forkedandjoined.model.EnrolmentMgmt;
...
@ModuleDescriptor(
    ...
    viewDesc=@ViewDesc(
        formTitle="Manage Enrolment Managements (Forked & Joined)",
    ...
    ,isPrimary=true,
    childModules={ModuleStudent.class, ModuleFEnrolmentProcessing.class, ModuleSClassRegistration.class}
