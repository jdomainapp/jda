...
public class CourseModule {
    ...
    public CourseModule(@AttrRef(value = "id") Integer id, @AttrRef(value = "code") String code, @AttrRef(value = "name") String name, @AttrRef(value = "semester") Integer semester, @AttrRef(value = "credits") Integer credits) throws ConstraintViolationException {
        this.id = genId(id);
    ...
    public CourseModule(@AttrRef(value = "name") String name, @AttrRef(value = "semester") Integer semester, @AttrRef(value = "credits") Integer credits) throws ConstraintViolationException {
        this.id = genId(null);
