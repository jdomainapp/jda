package org.jda.example.courseman.swclasses.cls4.modules.enrolmentmgmt;
...
@ModuleDescriptor(
    ...
    viewDesc=@ViewDesc(
        formTitle="Manage Enrolment Management",  // derived from Decisional pattern
        domainClassLabel="Enrolment Management",    
        imageIcon="enrolment.jpg",
        view=View.class,
        viewType=RegionType.Data,
         // SW4: view config customisation -> view code customisation
        layoutBuilderType=TabLayoutBuilder.class, //DecisionalLayoutBuilder.class,  
        topX=0.5,
        topY=0.0,  // SW4: view config configuration
...
public class ModuleEnrolmentMgmt {
  // SW4: 
  //- view config + code customisation : all fields
  //- controller config + code customisation: students
  ...
  @AttributeDesc(label="Student Registration",
      layoutBuilderType=TwoColumnLayoutBuilder.class  // SW4: view config + code customisation
      ,controllerDesc=@ControllerDesc( // SW4: controller config + code customisation
  ...
  @AttributeDesc(label="Help Request"
      ,type=DefaultPanel.class  // SW4: view config + code customisation
  )
