...
@Controller
public class ServiceReconfigurerControllerBasic {
...
//		}
	...
	public String sendFile (String targetHost, String module, File jarFile) {
		...
		ResponseEntity<String> restExchange = restTemplate.exchange(fullTargerURL, HttpMethod.POST, requestEntity, String.class, module);
