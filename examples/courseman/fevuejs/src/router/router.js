...
import { STUDENT_INDEX_PATH, STUDENT_LIST_PATH, STUDENT_ADD_PATH, STUDENT_EDIT_PATH } from './path.js'
import { ADDRESS_INDEX_PATH, ADDRESS_EDIT_PATH, ADDRESS_LIST_PATH, ADDRESS_ADD_PATH } from './path.js'
import { STUDENT_CLASS_INDEX_PATH, STUDENT_CLASS_LIST_PATH, STUDENT_CLASS_ADD_PATH, STUDENT_CLASS_EDIT_PATH } from './path.js'
import { ENROLMENT_INDEX_PATH, ENROLMENT_LIST_PATH, ENROLMENT_ADD_PATH, ENROLMENT_EDIT_PATH } from './path.js'
import { COURSEMODULE_INDEX_PATH, COURSEMODULE_LIST_PATH, COURSEMODULE_ADD_PATH, COURSEMODULE_EDIT_PATH } from './path.js'

//name
import { HOME_NAME } from './name.js'
import { STUDENT_INDEX_NAME, STUDENT_LIST_NAME, STUDENT_ADD_NAME, STUDENT_EDIT_NAME } from './name.js'
import { ADDRESS_INDEX_NAME, ADDRESS_EDIT_NAME, ADDRESS_LIST_NAME, ADDRESS_ADD_NAME } from './name.js'
import { STUDENT_CLASS_INDEX_NAME, STUDENT_CLASS_LIST_NAME, STUDENT_CLASS_ADD_NAME, STUDENT_CLASS_EDIT_NAME } from './name.js'
import { ENROLMENT_INDEX_NAME, ENROLMENT_LIST_NAME, ENROLMENT_ADD_NAME, ENROLMENT_EDIT_NAME } from './name.js'
import { COURSEMODULE_INDEX_NAME, COURSEMODULE_LIST_NAME, COURSEMODULE_ADD_NAME, COURSEMODULE_EDIT_NAME } from './name.js'

//component
import { HOME } from './comonent.js'
import { STUDENT_INDEX, STUDENT_LIST, STUDENT_ADD, STUDENT_EDIT } from './comonent.js'
import { ADDRESS_INDEX, ADDRESS_EDIT, ADDRESS_LIST, ADDRESS_ADD } from './comonent.js'
import { STUDENT_CLASS_INDEX, STUDENT_CLASS_LIST, STUDENT_CLASS_ADD, STUDENT_CLASS_EDIT } from './comonent.js'
import { ENROLMENT_INDEX, ENROLMENT_LIST, ENROLMENT_ADD, ENROLMENT_EDIT } from './comonent.js'
import { COURSEMODULE_INDEX, COURSEMODULE_LIST, COURSEMODULE_ADD, COURSEMODULE_EDIT } from './comonent.js'
