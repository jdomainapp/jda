...
public class Student implements Serializable {
  ...
  @DAssoc(ascName="student-has-enrolments",role="student",
    ...
    associate=@Associate(type=Enrolment.class,cardMin=0,
      cardMax=25
      ))
  ...
  public Student(String name, String dob, City address, String email, SClass sclass, List<Enrolment> enrolments) {
  ...
  public Student(String id, String name, String dob, City address, String email, SClass sclass, List<Enrolment> enrolments) 
