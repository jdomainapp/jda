package org.courseman.backend.services.coursemodule;
...
@Service(value = "org.courseman.backend.services.coursemodule.CourseModuleService")
public class CourseModuleService extends InheritedDomServiceAdapter<org.courseman.modules.coursemodule.model.CourseModule> {
    ...
    @Autowired()
    public CourseModuleService(jda.mosa.software.impl.SoftwareImpl arg0, @Qualifier(value = "org.courseman.modules.coursemodule.model.CourseModule") java.util.Map arg1) {
        super(arg0, arg1);
