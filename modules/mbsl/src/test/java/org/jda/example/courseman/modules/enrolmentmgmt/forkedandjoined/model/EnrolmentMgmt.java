package org.jda.example.courseman.modules.enrolmentmgmt.forkedandjoined.model;
...
@ANode(refCls=FEnrolmentProcessing.class, serviceCls=DataController.class, nodeType=NodeType.Fork, 
      outClses={Payment.class, Authorisation.class}),
@ANode(refCls=Payment.class, serviceCls=DataController.class, outClses={JPaymentAuthorise.class}, 
      actSeq={
...
@ANode(refCls=Authorisation.class, serviceCls=DataController.class, outClses={JPaymentAuthorise.class}, 
      actSeq={
        // create new and return immediately
        @MAct(actName=MethodName.newObject),  
        // set value for HelpDesk.Student
...
public class EnrolmentMgmt {
  ...
  // payment processing 
  @DAttr(name="enrolmentProcs", type=Type.Collection,filter=@Select(clazz=FEnrolmentProcessing.class),serialisable=false)
  ...
  private Collection<FEnrolmentProcessing> enrolmentProcs;
