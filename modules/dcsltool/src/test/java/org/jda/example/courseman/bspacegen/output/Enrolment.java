...
public class Enrolment {
    ...
    public Enrolment(@AttrRef(value = "id") Integer id, @AttrRef(value = "student") Student student, @AttrRef(value = "module") CourseModule module, @AttrRef(value = "internalMark") Double internalMark, @AttrRef(value = "examMark") Double examMark, @AttrRef(value = "finalGrade") Character finalGrade) throws ConstraintViolationException {
        this.id = genId(id);
        this.student = student;
        this.module = module;
        this.internalMark = internalMark;
    ...
    public Enrolment(@AttrRef(value = "student") Student student, @AttrRef(value = "module") CourseModule module, @AttrRef(value = "internalMark") Double internalMark, @AttrRef(value = "examMark") Double examMark) throws ConstraintViolationException {
        this.id = genId(null);
        this.student = student;
        this.module = module;
        this.internalMark = internalMark;
    ...
    public Enrolment(@AttrRef(value = "student") Student student, @AttrRef(value = "module") CourseModule module) throws ConstraintViolationException {
        this.id = genId(null);
        this.student = student;
        this.module = module;
