...
|                                                                                                                                |                                                                                                        |                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| ![](./example_assert/Screen_Recording_HomeScreen.gif) <p align = "center">Route to modules from home screen</p>                | ![](./example_assert/Screen_Recording_ShowDetailView.gif)<p align = "center">Show detail of module</p> | ![](./example_assert/Screen_Recording_CreateItem.gif) <p align = "center">Create new item</p>   |
| ![](./example_assert/Screen_Recording_EditItem.gif)<p align = "center">Edit an item</p>                                        | ![](./example_assert/Screen_Recording_DeleteItem.gif) <p align = "center">Delete an item</p>           | ![](./example_assert/Screen_Recording_MultiInput.gif) <p align = "center">Using multi input</p> |
| ![](./example_assert/Screen_Recording_GenericFormWithType.gif) <p align = "center">The form with type for genenric modules</p> |                                                                                                        |                                                                                                 |
