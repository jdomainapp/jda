...
import jda.modules.restfstool.backend.base.controllers.DefaultRestfulWithInheritanceController;
...
public class CourseModuleController extends DefaultRestfulWithInheritanceController<com.hanu.courseman.modules.coursemodule.model.CourseModule> {
    ...
    @Autowired()
    public CourseModuleController(jda.modules.restfstool.backend.base.websockets.WebSocketHandler arg0) {
        super(arg0);
    }
}
