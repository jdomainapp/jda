package org.jda.example.courseman.modules.enrolmentmgmt.sequential;
...
@ModuleDescriptor(
    ...
    viewDesc=@ViewDesc(
        formTitle="Manage Enrolment Managements (Sequential)",
        domainClassLabel="Enrolment Management",    
        imageIcon="enrolment.jpg",
        view=View.class,
        viewType=RegionType.Data,
        layoutBuilderType=SequentialLayoutBuilder.class, //TabLayoutBuilder.class,
