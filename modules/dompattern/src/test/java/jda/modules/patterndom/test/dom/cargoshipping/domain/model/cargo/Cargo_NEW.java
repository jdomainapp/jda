 ...
 */
@DClass()
public class Cargo_NEW implements Entity<Cargo_NEW>, AGRoot {
    ...
    public Cargo_NEW(final TrackingId trackingId, final RouteSpecification routeSpecification) {
   ...
   * to happen <b>asynchronously</b> since {@link jda.modules.patterndom.test.dom.cargoshipping.domain.model.handling.HandlingEvent} is in a different aggregate.
   *
   ...
   */
    ...
    @Override
    public boolean sameIdentityAs(final Cargo_NEW other) {
   ...
   */
    ...
    public boolean equals(final Object object) {
        ...
        if (object == null || getClass() != object.getClass())
            return false;
        final Cargo_NEW other = (Cargo_NEW) object;
   ...
   */
    ...
    private <T extends Publisher> void updateOnMemberAdded(Class<T> memberCls, T member) {
        ...
        /* ducmle: modified for the Cargo's logic
        if (memberCls == RouteSpecification.class) {
            RouteSpecification m1 = (RouteSpecification) member;
     ...
     */
    private void updateOnMember1Added(RouteSpecification someMember) throws ConstraintViolationException {
        // keep a record of prevState (before update)
        Object prevState = 
            this.routeSpecification;  // NEW
     ...
     *  rethrow {@link ConstraintViolationException}. 
     */
    private void updateOnItineraryAdded(Itinerary someMember) throws ConstraintViolationException {
        // keep a record of prevState (before update)
        Object prevState = 
            this.itinerary;  // NEW
   ...
   *  rethrow {@link ConstraintViolationException}. 
   */
    private void updateOnMember1Changed(RouteSpecification someMember, Object... args) throws ConstraintViolationException {
        // keep a record of prevState (before update)
   ...
   *  rethrow {@link ConstraintViolationException}. 
   */
    private void updateOnMember1Removed(RouteSpecification someMember, Object... args) throws ConstraintViolationException {
        // keep a record of prevState (before update)
        Object prevState = null;
        // Pattern: aggregates
        commitUpdate(prevState);
   ...
   */
    private void rollbackUpdate(Object prevState) {
      // NEW
      specifyNewRoute((RouteSpecification) prevState);
    }
}
