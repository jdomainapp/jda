...
import jda.test.app.courseman.extended.units.association.SetAssociationLinkCount;
...
@Suite.SuiteClasses({
  ...
  LoadObjects.class,
  Spacer.class,
  SetAssociationLinkCount.class,
        })
public class SetAssociationLinkCountSuite {
  // define a test suite
}
