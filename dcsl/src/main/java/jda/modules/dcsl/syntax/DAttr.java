...
public @interface DAttr {
   ...
   * @see also {@link #cid()}
   */
  String ccid() default CommonConstants.NullString;
   ...
   **/
  int length() default  DCSLConstants.DEFAULT_DATTR_LENGTH;
   ...
   * */
  double min() default CommonConstants.DEFAULT_MIN_VALUE;
  ...
  double max() default CommonConstants.DEFAULT_MAX_VALUE;
   ...
   * @version 3.0
   */
  String sourceAttribute() default CommonConstants.NullString;
   ...
   * @version 3.1 
   */
  boolean sourceQuery() default false;
   ...
   * <p>Default: <tt>false</tt> (i.e. no source query is used)
   */
  boolean sourceQueryHandler() default false;
...
//  public Select minFilter() default @Select();
  ...
  String defaultValue() default CommonConstants.NullString;
...
//  public String role() default Null;
   ...
   */
  Format format() default Format.Nil;
