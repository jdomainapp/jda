...
import org.jda.example.courseman.software.config.enrolmentmgmt.ForkedSystemClass;
 ...
 * @version 
 */
public class ForkedCourseManSoftware {
  
  public static void main(String[] args) {
    // create a default software needed to run the activity
    Software sw;
    try {
      sw = SoftwareFactory.createSoftwareWithMemoryBasedConfig(ForkedSystemClass.class);
