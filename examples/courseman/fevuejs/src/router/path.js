...
//export const STUDENT_EDIT_PATH = '/student-edit';

export const ADDRESS_INDEX_PATH = '/address';
// export const ADDRESS_EDIT_PATH = '/address-edit';
...
//export const STUDENT_CLASS_EDIT_PATH = '/student-class-edit';
...
//export const ENROLMENT_EDIT_PATH = '/enrolment-edit';

export const COURSEMODULE_INDEX_PATH = '/course-module';
export const COURSEMODULE_LIST_PATH = '/course-module-list';
export const COURSEMODULE_ADD_PATH = '/course-module-add';
//export const COURSEMODULE_EDIT_PATH = '/course-module-edit';