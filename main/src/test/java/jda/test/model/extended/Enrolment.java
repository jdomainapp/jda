...
public class Enrolment implements Comparable, Serializable {
  ...
  @DAssoc(ascName = "student-has-enrolments", role = "enrolment", ascType = AssocType.One2Many, endType = AssocEndType.Many, associate = @Associate(type = Student.class, cardMin = 1, cardMax = 1), dependsOn = true)
  private Student student;

  @DAttr(name = "module", type = Type.Domain, length = 5, optional = false)
  @DAssoc(ascName = "module-has-enrolments", role = "enrolment", ascType = AssocType.One2Many, endType = AssocEndType.Many, associate = @Associate(type = Module.class, cardMin = 1, cardMax = 1), dependsOn = true)
  ...
  // constructor method
  public Enrolment(Student s, Module m) throws ConstraintViolationException {
    this(null, s, m, 0.0, 0.0);
  }

  public Enrolment(Student s, Module m, Double internalMark, Double examMark)
      throws ConstraintViolationException {
    this(null, s, m, internalMark, examMark);
  }

  // @version 2.0
  public Enrolment(Integer id, Student s, Module m, Double internalMark,
      Double examMark) throws ConstraintViolationException {
/* v3.2
    this.id = nextID(id);
    this.student = s;
    this.module = m;
    ...
    updateFinalMark(); 
*/ 
    this(id, s, m, internalMark, examMark, null);
  }
