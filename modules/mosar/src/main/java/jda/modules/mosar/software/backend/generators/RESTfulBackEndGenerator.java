...
import jda.modules.mosar.software.backend.BEGenOutput;
...
//    }
    ...
    /**
     * @requires
     *  every class in <code>domainModel</code> is expressed in DCSL and annotated 
     *  with suitable Json annotations (generated by {@link AnnotationGenerator}.
     *  
     * Generate a simple RESTful Web Service from a number of domain classes.
     * @param domainModel
     */
    public BEGenOutput run(Class... domainModel) {
