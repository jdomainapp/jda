...
import org.jda.example.courseman.software.config.enrolmentmgmt.JoinedSystemClass;
 ...
 * @version 
 */
public class JoinedCourseManSoftware {
  
  public static void main(String[] args) {
    try {
      // create a default software needed to run the activity
      Software sw = SoftwareFactory.createSoftwareWithMemoryBasedConfig(JoinedSystemClass.class);
